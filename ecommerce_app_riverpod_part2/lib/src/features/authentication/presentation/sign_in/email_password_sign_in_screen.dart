...
// * Stateful -> StatefulConsumberWidget
// * State -> ConsumerState
...
class _EmailPasswordSignInContentsState
  ...
  // https://codawithandrea.com/articles/flutter-text-field-form-validation/
  ...
  void _updateFormType(EmailPasswordSignInFormType formType) {
    ...
    ref.read(emailPasswordSignInControllerProvider(widget.formType).notifier);
