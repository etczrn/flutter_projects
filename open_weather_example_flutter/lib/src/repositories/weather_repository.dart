...
// * repository pattern is great for abstracting away
// * all the networking and JSON serialization code.
// * What matters is that the repository allows us to define a contract
// * for how to retrieve the weather for a given city.
